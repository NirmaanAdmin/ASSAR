<script>
   ...
   var cycle_summary_table;
   cycle_summary_table = $('.cycle_summary_table');
   initDataTable('.cycle_summary_table', admin_url + 'purchase/get_compounding_cycle_summary_table', [], [], {}, [0, 'asc'], false);
</script>